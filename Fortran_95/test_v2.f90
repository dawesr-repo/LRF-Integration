...
contains
        ...
        Subroutine RunningTime_Performance(coeff_filename,fileOutputNumber)
                ...
                do i=1,ntest
                        call Evaluate_LRF(E1,SixD_coord,"Euler_ZYZ",XDIM,coeff_filename)
                end do
        ...
        Subroutine Check_MATLAB_ENERGY(SystemName,XDIM,verbose,fileOutputNumber)
                ...
                Open( 17, file = '../testing_datafiles/datasets/'//SystemName//'.txt' )
                ALLOCATE(coord(XDIM))
                ...
                do i=1,ntest
                        ...
                        call Evaluate_LRF(E1,coord,"Euler_ZYZ",XDIM,'../testing_datafiles/coefficients/'//SystemName//'_Coeff.txt')
...
PROGRAM main_subroutine
        ...
        call FileChecking('../testing_datafiles/output.test.txt',fileOutNumber)
        ...
        call RunningTime_Performance('../testing_datafiles/coefficients/C1(1)_C1(1)_Coeff.txt',fileOutNumber)
