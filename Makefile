...
OBJS_PROD =  production_cp.o   Multipoles.o 
OBJS_PROD_Test =  production_cp.o    test.o
...
build-run-prod : $(OBJS_PROD)
	$(F90) $(OBJS_PROD) -o ejec_prod.x
	./ejec_prod.x

build-run-test-prod : $(OBJS_PROD_Test)
