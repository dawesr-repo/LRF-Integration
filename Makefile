...
OBJS = 		 Geometry_Constant.o Geometry_Constant_v2.o FittingConstant.o  Search.o helperFunc.o Multipole_Sph3.o Induction_Sph3.o min_example.o 
OBJS_Test =  Geometry_Constant.o FittingConstant.o  Search.o helperFunc.o Multipole_Sph2.o  Dispersion_Sph2.o Induction_Sph2.o  test.o
